cordova.define("cordova-plugin-qrscanner.QRScanner", function(require, exports, module) { // The native implementations should return their status as ['string':'string']
